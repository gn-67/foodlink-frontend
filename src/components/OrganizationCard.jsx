  ...
  return (
    <div className="card bg-white">
      ...
      {commonDistributions && commonDistributions.length > 0 && (
        <div className="mb-3">
          <div className="text-xs font-medium text-gray-500 mb-1">THEY DISTRIBUTE:</div>
      ...
      <div className="border-t border-gray-200 pt-3 space-y-2">
        <div className="text-xs font-medium text-gray-500 mb-2">CONTACT TO COORDINATE:</div>
